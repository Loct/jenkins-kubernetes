...
#rewrite cassandra hosts
iptables -t nat -A PREROUTING -s 10.156.0.18 -p tcp --dport 9042 -j DNAT --to-destination 35.234.65.129:9042
iptables -t nat -A PREROUTING -s 10.156.0.19 -p tcp --dport 9042 -j DNAT --to-destination 35.198.97.13:9042
iptables -t nat -A PREROUTING -s 10.156.0.30 -p tcp --dport 9042 -j DNAT --to-destination 35.234.101.239:9042
